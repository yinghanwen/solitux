...
#define SD_DATA(x)      (x << 12)
#define SD_DPL(x)       (x << 13)
#define SD_PRS(x)       (x << 14)
#define SD_AVL(x)       (x << 20)
#define SD_64(x)        (x << 21)
#define SD_32(x)        (x << 22)
#define SD_GRAN(x)      (x << 23)

#define SEG_LIM_L(x)    (x & 0x0ffff)
#define SEG_LIM_H(x)    (x & 0xf0000)
#define SEG_BASE_L(x)   ((x & 0x0000ffff) << 32)
#define SEG_BASE_M(x)   ((x & 0x00ff0000) >> 32)
...
#define SEG_R0_CODE         SD_TYPE(SEG_CODE_EXRD) | SD_CODE_DATA(1) | SD_DPL(0) | \
                            SD_PRS(1) | SD_AVL(0) | SD_64(0) | SD_32(1) | \
                            SD_GRAN(1)
...
#define SEG_TSS             SD_TYPE(9) | SD_DPL(0) | SD_PRS(1)
